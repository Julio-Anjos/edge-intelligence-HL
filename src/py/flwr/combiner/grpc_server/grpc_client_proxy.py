...
from flwr.combiner.grpc_server.grpc_bridge import GRPCBridge, InsWrapper, ResWrapper
...
class GrpcClientProxy(ClientProxy):
    ...
    def fit(self, server_msg: ServerMessage) -> common.FitRes:
    ...
    def evaluate(self, server_msg: ServerMessage) -> common.EvaluateRes:
